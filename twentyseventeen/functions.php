...
function twentyseventeen_scripts() {
	...
	wp_enqueue_style( 'twentyseventeen-custom', get_theme_file_uri( '/assets/css/custom.css' ), array( 'twentyseventeen-style' ), '1.0' );

	if ( is_rtl() ) {
		// Theme custom RTL stylesheet.
		wp_enqueue_style( 'twentyseventeen-custom-rtl', get_theme_file_uri( '/assets/css/custom-rtl.css' ), array( 'twentyseventeen-style' ), '1.0' );
	}
...
/* taxonomy of custom post type - book */
function create_book_taxonomies() {
	$labels = array(
		...
		'menu_name'         => __( 'Genre', 'twentyseventeen' ),
	);
